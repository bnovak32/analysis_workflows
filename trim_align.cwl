...
inputs:
  ...
  sort_mode:
    ...
    doc: |
      ...
      * readname: sort by read names (ie, the QNAME field)
      * template-coordinate: sort by unclipped 5' coordinate, library, molecular barcode, readname
